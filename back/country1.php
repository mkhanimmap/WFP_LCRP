...
.mtree-skin-selector button.csl.active {
  ...
  <div style="z-index:12; position:absolute; float:right; width:100%;">
  	<div style="width:15%; float:right;"><div class="dropdown" style="width:200px;" id="divPartner">
        <?php
		  loadPartner("'".'DisSyr - # of vulnerable individuals receiving e-cards'."'");
        ?>
        </div></div>
    <div style="width:15%; float:right;"><div class="dropdown" style="width:200px;" id="divBeneficiaryGroup">
        <?php
		 loadBeneficiaryGroup("'".'DisSyr - # of vulnerable individuals receiving e-cards'."'");
        ?>
        </div></div>
        <div style="width:15%; float:right;"><div class="dropdown" style="width:200px;" id="divMonth">
        <?php
		 loadMonth("'".'DisSyr - # of vulnerable individuals receiving e-cards'."'");
        ?>
        </div></div>
        <div style="width:15%; float:right;"><div class="dropdown" style="width:200px;" id="divYear">
        <?php
